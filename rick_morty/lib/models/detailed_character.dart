class DetailedCharacter {
  ...
  factory DetailedCharacter.fromJson(Map<String, dynamic> json) {
    return DetailedCharacter(
      ...
      //   ).map((e) => ProductionCompany.fromJson(e)).toList(),
      //   productionCountries: List.from(
      //     json['production_countries'],
      //   ).map((e) => ProductionCountry.fromJson(e)).toList(),
      //   releaseDate: json['release_date'],
      //   revenue: json['revenue'],
      //   runtime: json['runtime'],
      //   spokenLanguages: List.from(
      //     json['spoken_languages'],
      //   ).map((e) => SpokenLanguage.fromJson(e)).toList(),
      //   status: json['status'],
...
//     return SpokenLanguage(iso_639_1: json['iso_639_1'], name: json['name']);
//   }
